...
var isOnlineFromState = function (_a) {
    ...
    return isInternetReachable === null ? isConnected : isInternetReachable;
};
var api = undefined;
exports.getApi = function () { return __awaiter(void 0, void 0, void 0, function () {
    var isOnLine, _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                _a = isOnlineFromState;
                return [4 /*yield*/, NetInfo.fetch()];
            case 1:
                isOnLine = _a.apply(void 0, [_b.sent()]);
                api = {
                ...
                return [2 /*return*/, exports.getApi()];
        }
    });
}); };
