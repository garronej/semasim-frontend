...
export declare const createStripeCheckoutSessionForShop: (cart: import("../types/shop").Cart, shippingFormData: import("../types/shop").ShippingFormData, currency: string, success_url: string, cancel_url: string) => Promise<apiDeclaration.createStripeCheckoutSessionForShop.Response>;
...
export declare const getOrders: () => Promise<apiDeclaration.getOrders.Response>;
