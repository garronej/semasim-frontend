...
var Webphone;
(function (Webphone) {
    function createFactory(ua, appEvts, getWdApiCallerForSpecificSim, coreApiCaller) {
        return function create(userSim) {
            return __awaiter(this, void 0, void 0, function () {
                var uaSim, wdApiCallerForSpecificSim, _a, wdChats, wdEvts, webphone;
                var _this = this;
                    ...
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            webphone = {
                                ...
                                wdChats: wdChats,
                                wdEvts: wdEvts,
                                "evtIsSipRegisteredValueChanged": new ts_events_extended_1.VoidSyncEvent(),
                                "getIsSipRegistered": function () { return uaSim.isRegistered; },
                                "evtIncomingCall": new ts_events_extended_1.SyncEvent(),
                                "sendMessage": function (wdChat, text) { return __awaiter(_this, void 0, void 0, function () {
                                    ...
                                    return __generator(this, function (_c) {
                                        switch (_c.label) {
                                            ...
                                            case 3:
                                                _c.trys.push([3, 5, , 7]);
                                                return [4 /*yield*/, uaSim.sendMessage(wdChat.contactNumber, bundledData)];
                                            case 4:
                                                _c.sent();
                                                return [3 /*break*/, 7];
                                            case 5:
                                ...
                                "placeOutgoingCall": function (number) { return uaSim.placeOutgoingCall(number); },
                            ...
                            uaSim.evtIncomingMessage.attach(function (_a) {
                            ...
                            uaSim.evtIncomingCall.attach(function (_a) {
                                ...
                                return __awaiter(_this, void 0, void 0, function () {
                                    ...
                                    return __generator(this, function (_b) {
                                        switch (_b.label) {
                                            ...
                                            case 1:
                                                wdChat = _b.sent();
                                                webphone.evtIncomingCall.post({ wdChat: wdChat, terminate: terminate, prTerminated: prTerminated, onAccepted: onAccepted });
                                                return [2 /*return*/];
                                        }
                                    });
                                });
                            });
                            uaSim.evtRegistrationStateChanged.attach(function () { return webphone.evtIsSipRegisteredValueChanged.post(); });
