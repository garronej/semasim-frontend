...
var Ua_backup_1 = require("./Ua.backup");
 ...
 *
 * */
function setupEncryptorDecryptorsAndInitializeUa(pushNotificationToken) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, email, uaInstanceId, encryptedSymmetricKey, towardUserKeys, towardUserDecryptor, aesWorkerThreadPoolId, _b, _c, _d, _e, _f, _g;
        return __generator(this, function (_h) {
            switch (_h.label) {
                case 0: return [4 /*yield*/, AuthenticatedSessionDescriptorSharedData_1.AuthenticatedSessionDescriptorSharedData.get()];
                case 1:
                    _a = _h.sent(), email = _a.email, uaInstanceId = _a.uaInstanceId, encryptedSymmetricKey = _a.encryptedSymmetricKey;
                ...
                case 3:
                    _c.apply(_b, [_e.apply(_d, [_h.sent(),
                            aesWorkerThreadPoolId])]);
                    _f = pushNotificationToken !== undefined;
                    if (!_f) return [3 /*break*/, 5];
                    _g = pushNotificationToken;
                ...
                case 6:
                    ...
                    _h.label = 7;
                case 7:
                    Ua_backup_1.Ua.staticInitialization({
                        "ua": {
...
exports.setupEncryptorDecryptorsAndInitializeUa = setupEncryptorDecryptorsAndInitializeUa;
