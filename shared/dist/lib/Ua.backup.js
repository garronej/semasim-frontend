...
var Ua = /** @class */ (function () {
    ...
    function Ua(imsi, sipPassword, towardSimEncryptor) {
        var _this = this;
        ...
        */
        ...
        var uri = "sip:" + imsi + "@" + env_1.env.baseDomain;
        ...
        this.jsSipUa = new JsSIP.UA({
            ...
            "instance_id": Ua.staticParams.ua.instance.match(/"<urn:([^>]+)>"$/)[1],
            "register": false,
            "contact_uri": uri + ";" + serializedUaObjectCarriedOverSipContactParameter.buildParameter(__assign(__assign({}, Ua.staticParams.ua), { "platform": (function () {
        ...
        this.jsSipUa.on("registrationExpiring", function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                console.log("Ua registration expiring for " + imsi + ", re registering");
    ...
    Ua.staticInitialization = function (staticParams) {
        Ua.staticParams = staticParams;
    };
    ...
    */
     ...
     * */
    Ua.prototype.deFactoUnregistered = function () {
        this.jsSipUa.emit("unregistered");
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, bundledData_1.extractBundledDataFromHeaders((function () {
                            ...
                            return out;
                        })(), Ua.staticParams.towardUserDecryptor)];
                    case 1:
                        bundledData = _a.sent();
