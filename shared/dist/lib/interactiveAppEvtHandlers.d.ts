...
export declare function registerInteractiveAppEvtHandlers(appEvts: AppEvts, remoteCoreApiCaller: RemoteCoreApiCaller, dialogApi: DialogApi, startMultiDialogProcess: (typeof import("../tools/modal/dialog"))["startMultiDialogProcess"], restartApp: (typeof import("./restartApp"))["restartApp"]): void;
export {};
