...
export declare function factory(params: {
    ...
    getWdApiFactory: ({ encryptorDecryptor, userEmail }: {
        encryptorDecryptor: import("crypto-lib/dist/sync/types").EncryptorDecryptor;
        userEmail: string;
    }) => ({ imsi }: {
        imsi: string;
    }) => {
        getUserSimChats: ({ maxMessageCountByChat }: {
            ...
            wdEvts: import("../../../tools/NonPostableEvts").NonPostableEvts<import("../../types/webphoneData").Evts>;
        }>;
    ...
    getCoreApi: ({ userEmail }: {
        ...
        getUserSims: ({ includeContacts }: {
            ...
            userSimEvts: import("../../../tools/NonPostableEvts").NonPostableEvts<import("../../types").UserSim.Evts>;
        }>;
