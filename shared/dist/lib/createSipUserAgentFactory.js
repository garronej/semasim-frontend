...
var SipUserAgent = /** @class */ (function () {
    function SipUserAgent(params) {
        ...
        */
        ...
        this.evtIncomingCall = new evt_1.Evt();
        ...
        var obsIsRegistered = new evt_1.Observable(false);
        ...
        */
        ...
        this.jsSipUa.on("unregistered", function () { return obsIsRegistered.onPotentialChange(false); });
    ...
    SipUserAgent.prototype.onIncomingCall = function (jsSipRtcSession, request) {
        var _this = this;
        var evtRequestTerminate = new evt_1.VoidEvt();
        var evtAccepted = new evt_1.VoidEvt();
        var evtTerminated = new evt_1.VoidEvt();
        var evtDtmf = new evt_1.Evt();
        var evtEstablished = new evt_1.VoidEvt();
    ...
    SipUserAgent.prototype.placeOutgoingCall = function (number) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        evtEstablished = new evt_1.VoidEvt();
                        evtTerminated = new evt_1.VoidEvt();
                        evtDtmf = new evt_1.Evt();
                        evtRequestTerminate = new evt_1.VoidEvt();
                        evtRingback = new evt_1.VoidEvt();
...
var JsSipSocket = /** @class */ (function () {
    function JsSipSocket(imsi, connectionApi) {
        ...
        this.evtSipRegistrationSuccess = new evt_1.VoidEvt();
        this.evtUnderlyingSocketClose = new evt_1.VoidEvt();
