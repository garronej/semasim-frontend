...
const build_page = (target_module_dir_path, watch) => __awaiter(this, void 0, void 0, function* () {
    ...
    lib.tsc_browserify_minify(path.join(target_module_dir_path, "dist", "main.js"), path.join(__dirname, "..", "..", "..", "docs", `${path.basename(target_module_dir_path)}-${page_version}.js`), watch);
});
...
function program_action_build_pages(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield lib.tsc(path.join(frontend_root_dir_path, "shared", "tsconfig.json"), watch);
