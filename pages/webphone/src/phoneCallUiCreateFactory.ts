...
export function phoneCallUiCreateFactoryDependencyInjections(
    params: {
    ...
    class PhoneCallUiImpl implements types.PhoneCallUi {
        ...
        private readonly evtBtnClick = new Evt<"GREEN" | "RED">();

        private readonly evtNumpadDtmf = new Evt<{ signal: types.PhoneCallUi.DtmFSignal; duration: number }>();
        ...
        public readonly evtUiOpenedForOutgoingCall: types.PhoneCallUi["evtUiOpenedForOutgoingCall"] = new Evt();
    ...
    return id<types.PhoneCallUi.CreateFactory>(async function phoneCallUiCreateFactory(params) {
