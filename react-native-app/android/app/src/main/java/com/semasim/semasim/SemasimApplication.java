...
public class SemasimApplication extends Application implements ReactApplication {
  ...
  private final ReactNativeHost mReactNativeHost = new ReactNativeHost(this) {
    ...
    protected List<ReactPackage> getPackages() {
      ...
      packages.add(new HostPhoneCallUiPackage());
  ...
  public void onCreate() {
    ...
    Log.i("====================> SemasimApplication::onCreate");
  ...
  private void onCreateCustom(){
    ...
    WebRTCApiExposedByHostImpl.setAppContextGetter(SemasimApplication::getContext);
